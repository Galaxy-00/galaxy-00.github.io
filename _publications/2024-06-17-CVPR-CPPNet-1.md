...
citation: '<font face=Times New Roman><strong>Zhen Guo</strong> and Hongping Gan. CPP-Net: Embracing Multi-Scale Feature Fusion into Deep Unfolding CP-PPA Network for Compressive Sensing. In <i> Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR)</i>, 2024, pp. 25086-25095.</font>'
---
